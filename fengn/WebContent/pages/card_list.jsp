...
<script type="text/javascript">
	$(function() {
		 ...
		 $('#infoTable').bootstrapTable({  
		        url : '${basePath}/treeindex/card_query/'+agentId, // 请求后台的URL（*）            
		        method : 'get', // 请求方式（*）  
